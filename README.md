...
- **🃏 断句训练** — 43 句逐词拆解，每词标注词性色块 + 骨架规则编号
- **📝 核心词干** — 84 个最常用动词/形容词词干
- **🗓️ 两周日课表** — 每天 20 分钟，进度持久化到本地
- **🏷️ 标签速查表** — 助词、词尾、疑问词一览
- **🔊 Edge TTS 语音** — 微软 Edge TTS 韩语女声，自动缓存
- **🤖 AI 智能练句** — 输入任意中文，AI 自动翻译并按学习体系拆解词性、标注骨架规则
...
├── css/
│   └── style.css           # 全局样式 + 设计系统 + 动效
├── js/
│   ├── app.js              # 主应用逻辑（导航、渲染、AI、TTS）
│   ├── data.js             # 基础数据
