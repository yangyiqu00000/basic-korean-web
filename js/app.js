...
function renderHome() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🏠 归藏</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderSkeleton() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🏗️ 7 大筑基规则</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderTraining() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class=”page-title”><h2>🃏 抽丝训练</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderStems() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>📝 核心剥茧清单</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderSchedule() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🗓️ 两周润物表</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderReference() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🏷️ 标签拾遗表</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderAI() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🤖 砥砺</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderAIResult(data, container) {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  container.innerHTML = '<div class="ai-result-card"><div class="ai-result-header"><span class="ai-result-label">🤖 AI 拆解结果</span></div><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderScene() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="page-title"><h2>🎭 临境</h2><p>请启用 JavaScript 或使用现代浏览器</p></div>';
}
...
function renderSceneChat() {
  ...
  // [Vue 已接管] 回退仅保留基础内容
  return '<div class="chat-header"><button class="chat-back-btn" onclick="exitSceneChat()">← 返回</button><div class="chat-header-title">💬 ' + escapeHtml(sceneChatState.sceneTitle) + '</div><button class="chat-end-btn" onclick="finishSceneChat()">结束</button></div><div class="chat-container" id="chatContainer"><p style="padding:20px;text-align:center;color:var(--text-light);">请启用 JavaScript 或使用现代浏览器</p></div><div class="chat-input-bar"><button class="chat-mute-btn" id="muteBtn" onclick="toggleSceneMute()" title="静音/取消静音">' + (sceneChatState.muted ? '🔇' : '🔊') + '</button><input type="text" id="chatInput" class="ai-input" placeholder="输入中文或韩文回答…" disabled /><button class="ai-submit-btn" disabled>发送</button></div>';
}
...
function renderSceneReview() {
  ...
  main.innerHTML = '' +
    ...
    '</div>' +
    '<div class="review-container"><p style="padding:20px;text-align:center;color:var(--text-light);">请启用 JavaScript 或使用现代浏览器</p></div>' +
