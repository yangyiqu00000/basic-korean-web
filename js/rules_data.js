...
const RULES = [
  ...
  },
  {
    ...
    details: "해요체(-요体)=日常敬语 | 합쇼체(-습니다体)=正式 | 해체(반말)=亲密\n部分动词有专用敬语形式：먹다→드시다, 있다→계시다, 자다→주무시다",
    examples: [
      { kr: "할머니께서 진지를 드세요", breakdown: [["할머니+께서","奶奶(敬语主语)"], ["진지+를","饭(敬语)"], ["드세요","吃(敬语)"]] },
      { kr: "사장님은 사무실에 계세요", breakdown: [["사장+님은","社长(敬称)"], ["사무실+에","办公室"], ["계세요","在(敬语)"]] },
      { kr: "안녕하세요", breakdown: [["안녕하세요","您好(固定敬语)"]] }
    ],
    tip: "-요/습니다 是句子的社交收官符，决定了你跟对方的距离"
  },
  {
    id: 5,
    ...
    tip: "看到动词词干后面不是 -요/-습니다 而是 -고/-서/-지만/-면，就知道句子还没完"
  },
  {
    id: 6,
    title: "否定结构：안 / 못 / -지 않다",
